...
class ChildMixin:
    def get_parent(self, *args, **kwargs):
        ...
        if parent is None:
            ...
            parent = get_object_or_404(self.parent_model, id=parent_id)
        return parent
    ...
    def build_success_url(self):
        url_name = "{}-admin:{}-detail".format(
            self.parent_model._meta.app_label, self.parent_model._meta.model_name
        )
    ...
    def get_success_url(self):
        messages.success(
            self.request, "{} has been updated.".format(self.model._meta.verbose_name)
        )
