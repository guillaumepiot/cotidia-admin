...
class FieldRepresentationTests(TestCase):
    ...
    def test_integer_choice_field(self):
        ...
        self.assertEqual(field_repr["integer_choice_field"]["display"], "verbatim")
    ...
    def test_nullboolean_field(self):
        ...
        self.assertEqual(field_repr["nullboolean_field"]["filter"], "nullboolean_field")
    ...
    def test_overriding_field_representation_display(self):
        class TmpSerializer(ExampleModelOneSerializer):
            class SearchProvider:
                field_representation = {
                    "integer_field": {"display": "integer_field"},
                    "other_model__id": {"display": "other_model__id"},
                    "other_model__name": {"display": "other_model__name"},
                    "other_model__number": {"display": "other_model__number"},
                    "float_field": {"display": "float_field"},
                    "decimal_field": {"display": "decimal_field"},
                    "boolean_field": {"display": "boolean_field"},
                    "nullboolean_field": {"display": "nullboolean_field"},
                    "char_field": {"display": "char_field"},
                    "text_field": {"display": "text_field"},
                    "email_field": {"display": "email_field"},
                    "slug_field": {"display": "slug_field"},
                    "date_field": {"display": "date_field"},
                    "datetime_field": {"display": "datetime_field"},
                    "time_field": {"display": "time_field"},
                }
                filters = "__all__"

        field_repr = TmpSerializer().get_field_representation()

        self.assertEqual(field_repr["integer_field"]["display"], "integer_field")
        self.assertEqual(field_repr["other_model__id"]["display"], "other_model__id")
        self.assertEqual(
            field_repr["other_model__name"]["display"], "other_model__name"
        )
        self.assertEqual(
            field_repr["other_model__number"]["display"], "other_model__number"
        )
        ...
        self.assertEqual(
            field_repr["nullboolean_field"]["display"], "nullboolean_field"
        )
    ...
    def test_overriding_field_representation_filter(self):
        class TmpSerializer(ExampleModelOneSerializer):
            class SearchProvider:
                field_representation = {
                    "integer_field": {"filter": "integer_field"},
                    "other_model__id": {"filter": "other_model__id"},
                    "other_model__name": {"filter": "other_model__name"},
                    "other_model__number": {"filter": "other_model__number"},
                    "float_field": {"filter": "float_field"},
                    "decimal_field": {"filter": "decimal_field"},
                    "boolean_field": {"filter": "boolean_field"},
                    "nullboolean_field": {"filter": "nullboolean_field"},
                    "char_field": {"filter": "char_field"},
                    "text_field": {"filter": "text_field"},
                    "email_field": {"filter": "email_field"},
                    "slug_field": {"filter": "slug_field"},
                    "date_field": {"filter": "date_field"},
                    "datetime_field": {"filter": "datetime_field"},
        ...
        self.assertEqual(field_repr["integer_field"]["filter"], "integer_field")
        self.assertEqual(field_repr["other_model__id"]["filter"], "other_model__id")
        self.assertEqual(field_repr["other_model__name"]["filter"], "other_model__name")
        self.assertEqual(
    ...
    def test_many_to_many_field(self):
        ...
        self.assertEqual(field_repr["many_to_many_field"]["display"], "verbatim")
        self.assertEqual(
            field_repr["many_to_many_field"]["filter"], "many_to_many_field"
        )
