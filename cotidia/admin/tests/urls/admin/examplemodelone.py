...
urlpatterns = [
    re_path(
        ...
        {"app_label": "cotidia.admin.tests", "model": "examplemodelone"},
        name="examplemodelone-list",
    ),
    re_path(r"^add$", ExampleModelOneCreate.as_view(), name="examplemodelone-add"),
    re_path(
        r"^(?P<pk>[\d]+)$",
        ExampleModelOneDetail.as_view(),
        name="examplemodelone-detail",
    ),
    re_path(
        r"^(?P<pk>[\d]+)/update$",
        ExampleModelOneUpdate.as_view(),
        name="examplemodelone-update",
    ),
    re_path(
        r"^(?P<pk>[\d]+)/delete$",
        ExampleModelOneDelete.as_view(),
