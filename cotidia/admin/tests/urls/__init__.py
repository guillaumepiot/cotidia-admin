...
urlpatterns = [
    ...
    path(
        "account/", include("cotidia.account.urls.public", namespace="account-public")
    ),
    ...
    path(
        "admin/demo/",
        include("cotidia.admin.tests.urls.admin", namespace="tests-admin"),
    ),
    path(
        "api/admin/",
        include("cotidia.admin.tests.urls.api.dynamic_list", namespace="dynamic-api"),
    ),
