...
FIELD_MAPPING = {
    ...
    "EmailField": (lambda: {"display": "link:mailto", "filter": "text"}),
    "DateField": (lambda: {"display": "date", "filter": "date"}),
    "TimeField": (lambda: {"display": "datetime", "filter": "date"}),
    ...
    "FloatField": (lambda: {"display": "verbatim", "filter": "number"}),
    ...
    "AdminModelSerializer": (
        lambda: {"display": "verbatim", "filter": "choice", "foreign_key": True}
    ),
    "ListSerializer": (
        lambda: {"display": "verbatim", "filter": "choice", "foreign_key": True}
    ),
    "RelatedField": (
        lambda: {"display": "verbatim", "filter": "text", "foreign_key": True}
    ),
    "ManyRelatedField": (
        lambda: {"display": "verbatim", "filter": "text", "foreign_key": True}
    ),
